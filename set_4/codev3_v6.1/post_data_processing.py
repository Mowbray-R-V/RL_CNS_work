...
# Avg throughput rate
	...
	csv_print.data_csv(
		...
		avg_ta_time[0][0],                                        # ta
		avg_true_arr_rate[0],                               # na
		avg_tb_time[0][0],                                        # tb
		avg_nb[0],                                             # nb
		(avg_tb_time[0][0]  + avg_ta_time[0][0]),           # tc
		(avg_nb[0]  + avg_true_arr_rate[0]),               # nc
		((avg_tb_time[0][0]  + avg_ta_time[0][0])/(avg_nb[0]  + avg_true_arr_rate[0])),  # ratioc
		avg_frac_veh_crossed[0],								#crossing index
		(avg_true_arr_rate[0]/(8*(sp_t_limit - sp_t_start))),     # arr_rate
		avg_true_thro_rate[0],                                 # arr
